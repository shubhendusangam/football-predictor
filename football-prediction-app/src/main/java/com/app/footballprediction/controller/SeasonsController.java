...
public class SeasonsController {
     ...
     *
     * @param year Season identifier (e.g., "2023-24")
    ...
    public ResponseEntity<?> getSeasonStats(
        ...
        try {
            log.info("Fetching stats for season: {}, page: {}, pageSize: {}, sortBy: {}, sortDir: {}, team: {}",
                    year, page, pageSize, sortBy, sortDir, team);
            ...
            if (stats.getTotalMatches() == 0) {
                return ResponseEntity.ok(Map.of(
                        "message", "No data found for season: " + year,
                        "season", year,
                        "teamStats", List.of(),
                        "pagination", Map.of(
                                "page", page,
            ...
            log.error("Failed to fetch season stats for {}: {}", year, e.getMessage());
            return ResponseEntity.internalServerError().body(Map.of(
