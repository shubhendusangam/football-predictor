 ...
 * <p>
 * Register this filter as a Spring {@code @Component} in the module that
 * handles HTTP traffic, or via a {@code FilterRegistrationBean}.
 *
 * @see LogConstants
 */
public class MdcLoggingFilter implements Filter {
    ...
    /**
     * Use incoming {@code X-Request-ID} header if present (e.g. from a gateway),
    ...
    /**
     * Resolve client IP, respecting {@code X-Forwarded-For} when behind a proxy.
     */
